...
def pathfinding(filepath):
    ...
    start_pos, goal_pos = findStartAndGoal(start_grid)
    ...
    start_heuristic = getHeuristic(start_pos, goal_pos)
    ...
    while True:
        ...
        if curr_state.location == goal_pos:
        ...
        for node in getNeighbours(curr_state.grid, curr_state.location, curr_state.num_keys > 0):
            ...
            new_heuristic = getHeuristic(node, goal_pos)
